...
{
  	String_ID key = vars_save_string_lit("highlight_range");
	  b32 highlight_range = def_get_config_b32(key);
    def_set_config_b32(key, !highlight_range);
}
...
#define CJH_STRINGIFY(x) #x
#define CJH_TOKENPASTE(x, y) CJH_STRINGIFY(x ## y)

#define CJH_START_MULTI_KEY_CMD(category)                        \
    CUSTOM_COMMAND_SIG(cjh_start_multi_key_cmd_##category)       \
    {                                                            \
        String_ID cjh_mapid_##category =                         \
	          vars_save_string_lit(CJH_TOKENPASTE(cjh_mapid_, category));		 \
...
CUSTOM_COMMAND_SIG(cjh_enter_insert_mode)
{
    ...
    cjh_set_command_map(app, code_map_id);
...
custom_layer_init(Application_Links *app){
    ...
    cjh_setup_insert_mode_mapping(&framework_mapping, global_map_id, file_map_id, code_map_id);
    setup_essential_mapping(&framework_mapping, global_map_id, file_map_id, code_map_id);

    String_ID cjh_mapid_buffer = vars_save_string_lit("cjh_mapid_buffer ");
    String_ID cjh_mapid_c = vars_save_string_lit("cjh_mapid_c");
    String_ID cjh_mapid_comma = vars_save_string_lit("cjh_mapid_comma");
    String_ID cjh_mapid_d = vars_save_string_lit("cjh_mapid_d");
    String_ID cjh_mapid_file = vars_save_string_lit("cjh_mapid_file");
    String_ID cjh_mapid_g = vars_save_string_lit("cjh_mapid_g");
    String_ID cjh_mapid_help = vars_save_string_lit("cjh_mapid_help");
    String_ID cjh_mapid_macro = vars_save_string_lit("cjh_mapid_macro");
    String_ID cjh_mapid_normal_mode = vars_save_string_lit("cjh_mapid_normal_mode");
    String_ID cjh_mapid_profile = vars_save_string_lit("cjh_mapid_profile");
    String_ID cjh_mapid_quit = vars_save_string_lit("cjh_mapid_quit");
    String_ID cjh_mapid_snippet = vars_save_string_lit("cjh_mapid_snippet");
    String_ID cjh_mapid_space = vars_save_string_lit("cjh_mapid_space");
    String_ID cjh_mapid_toggle = vars_save_string_lit("cjh_mapid_toggle");
    String_ID cjh_mapid_visual_line_mode = vars_save_string_lit("cjh_mapid_visual_line_mode");
    String_ID cjh_mapid_visual_mode = vars_save_string_lit("cjh_mapid_visual_mode");
    String_ID cjh_mapid_window = vars_save_string_lit("cjh_mapid_window");
    String_ID cjh_mapid_y = vars_save_string_lit("cjh_mapid_y");
